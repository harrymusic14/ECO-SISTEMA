      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
        <div>
          ...
          <input 
            ...
            style={{ width: '100%', padding: '0.8rem', background: 'var(--bg-dark)', border: '1px solid var(--bg-elevated)', color: 'var(--text-light)', borderRadius: '4px' }}
          />
        </div>
        ...
        <div>
          <label style={{ display: 'block', marginBottom: '0.5rem', color: 'var(--text-secondary)' }}>Imagen (SOLO .webp o .avif)</label>
          <input 
            type="file" 
            accept="image/webp, image/avif" 
            onChange={handleFileChange}
            style={{ width: '100%', padding: '0.8rem', background: 'var(--bg-dark)', border: '1px dashed var(--bg-elevated)', color: 'var(--text-light)', borderRadius: '4px' }}
          />
          <small style={{ color: 'var(--text-muted)', display: 'block', marginTop: '0.5rem' }}>* Los formatos WebP y AVIF aseguran una carga súper rápida de la página (Lazy Loading).</small>
        </div>
